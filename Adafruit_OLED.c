...
//    1. Set the DC pin high or low. (Low for Command)
    GPIOPinWrite(GPIOA1_BASE, 0x1, 0);

//    2. Enable the SPI chip select  (MAP_SPICSEnable)
    MAP_SPICSEnable(GSPI_BASE);

//    3. Put the Data                (MAP_SPIDataPut)
    MAP_SPIDataPut(GSPI_BASE,c);

//    4. Clean up afterward using SPI Data_get  (MAP_SPIDataGet)
    MAP_SPIDataGet(GSPI_BASE,&ulDummy);

//    5. Disable SPI Chip Select.    (MAP_SPICSDisable)
